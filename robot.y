...
| WHILE LPAREN D COMMA NUMBER RPAREN LBRA commands RBRA { execute_commands($3, $5); }
;
// do(paint,down,4)
// move(up,4)
...
bool check(const char* direction, int distance) {
    ...
    return (targetX == coordinates_t.paintedX && targetY == coordinates_t.paintedY) ? true : false;
}
